<template>
  ...
  >
    ...
    <router-link
      to="/events"
      class="text-white bg-purple hover:bg-purple-dark rounded-lg px-2 py-3/2 font-bold mr-10per hidden md:block w-20 shadow text-center dark:text-dark-900 select-none"
    >
      Play!
    </router-link>
  </div>
